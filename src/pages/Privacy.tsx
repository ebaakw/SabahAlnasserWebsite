        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="p-8 bg-white/80 backdrop-blur-sm shadow-lg">
            <div className="space-y-6 arabic-body text-right">
              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">المقدمة</h2>
                <p className="leading-relaxed">
                  تلتزم جمعية العديلية التعاونية بحماية خصوصية مستخدمي تطبيقنا وموقعنا الإلكتروني. 
                  توضح هذه السياسة كيفية جمع واستخدام وحماية المعلومات الشخصية التي تقدمها لنا.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">المعلومات التي نجمعها</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">كيفية استخدام المعلومات</h2>
                <ul className="list-disc list-inside space-y-2 mr-4">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">مشاركة المعلومات</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">أمان المعلومات</h2>
                <p className="leading-relaxed">
                  نطبق إجراءات أمنية متقدمة لحماية معلوماتك، بما في ذلك التشفير وأنظمة الحماية المتعددة الطبقات.
                  نقوم بمراجعة وتحديث أنظمة الأمان بانتظام.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">حقوقك</h2>
                <ul className="list-disc list-inside space-y-2 mr-4">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">ملفات تعريف الارتباط (Cookies)</h2>
                <p className="leading-relaxed">
                  نستخدم ملفات تعريف الارتباط لتحسين تجربة المستخدم وتحليل استخدام الموقع. 
                  يمكنك إدارة إعدادات ملفات تعريف الارتباط من خلال متصفحك.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">التحديثات على السياسة</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary mb-3">التواصل معنا</h2>
                <p className="leading-relaxed">
                  في حالة وجود أي استفسارات حول سياسة الخصوصية، يرجى التواصل معنا:
                </p>
